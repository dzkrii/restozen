{{-- Footer --}}
<footer id="contact" class="pt-20 pb-8 px-4 sm:px-6 lg:px-8 bg-gray-900">
    <div class="max-w-7xl mx-auto">
        <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-gray-800">
            {{-- Company Info --}}
            <div class="lg:col-span-2">
                <a href="/" class="inline-block mb-6">
                    <img src="{{ asset('images/marupos-logo.png') }}" alt="MARUPOS Logo" class="h-12 w-auto brightness-0 invert">
                </a>
                ...
                <div class="flex items-center gap-3">
                    <a href="#" class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition-colors">
                        <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                    </a>
                    <a href="#" class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition-colors">
                    ...
                    <a href="#" class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition-colors">
                        <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                </div>
            </div>
            ...
            {{-- Product Links --}}
            <div>
                <h4 class="text-white font-semibold mb-5">Produk</h4>
                <ul class="space-y-3">
            ...
            {{-- Resources Links --}}
            <div>
                <h4 class="text-white font-semibold mb-5">Sumber Daya</h4>
                <ul class="space-y-3">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="https://wa.me/6285362489310" target="_blank" class="flex items-center gap-2 text-gray-400 hover:text-white transition-colors">
        ...
        <div class="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="#" class="text-gray-500 hover:text-gray-400 text-theme-sm transition-colors">Syarat & Ketentuan</a>
                <a href="#" class="text-gray-500 hover:text-gray-400 text-theme-sm transition-colors">Cookie</a>
            </div>
        </div>
    </div>
</footer>
