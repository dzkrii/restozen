<x-app-layout>
    <x-slot name="title">Tambah Kategori Menu</x-slot>
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Tambah Kategori Menu</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Buat kategori baru untuk menu</p>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl">
        <x-ui.card title="Informasi Kategori" description="Lengkapi data kategori menu di bawah ini">
            <form action="{{ route('menu-categories.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-ui.toggle name="is_active" :checked="true" label="Kategori aktif dan ditampilkan" />
                    </div>
                </div>
